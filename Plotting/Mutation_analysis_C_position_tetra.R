if (loadnetstat) {
  ...
  c_positions <- c(1)  # Add 2,3,4 when those files are available
...
mutation_pairs <- expand.grid(from = residues, to = residues, c_pos = c_positions)
...
plot_df$C_Position <- factor(plot_df$C_Position, 
                             levels = c_positions,
                             labels = paste0("C at position ", c_positions))
...
if (exists("save_plots") && save_plots) {
  ggsave(paste0(pltsavedir, "/Tetrapeptide_mutation_edges_C_absolute.png"), 
         plot = mut_detail_plt,
         dpi = 1100, 
         width = 6.5,
         height = 4,
         units = "in")
  if (otherstatpltsave) {
    ggsave(paste0(pltsavedir, "/Tetrapeptide_mutation_edges_C_std_dev.png"), 
    ...
    ggsave(paste0(pltsavedir, "/Tetrapeptide_mutation_edges_C_min.png"), 
    ...
    ggsave(paste0(pltsavedir, "/Tetrapeptide_mutation_edges_C_max.png"), 
    ...
    ggsave(paste0(pltsavedir, "/Tetrapeptide_mutation_edges_C_median.png"), 
