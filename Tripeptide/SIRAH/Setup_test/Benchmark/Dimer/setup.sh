#!/bin/bash
#gmx_mpi grompp -f ../md_CGPROT.mdp -p /dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/SIRAH/Setup_test/dim/C_A_A/C_A_A_SIRAH.top -po md.mdp -n /dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/SIRAH/Setup_test/dim/C_A_A/C_A_A_CG_solvated2.ndx -c /dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/SIRAH/Setup_test/dim/C_A_A/C_A_A_SIRAH_eq2.gro -o C_A_A_SIRAH_md.tpr > grompp_md_CGPROT.log 2>&1
...
core_counts=(1 4 8 16 24 32 40 64)

# Base directory for benchmarks
base_dir="/dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/SIRAH/Setup_test/Benchmark/Dimer/CPU/"
...
for version_key in "${!gmx_versions[@]}"; do
    ...
    for core_num in "${core_counts[@]}"; do
        ...
        # Run three replicas for each configuration
