...
#SBATCH --output=/dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/SIRAH/Setup_test/Benchmark/Dimer/CPU//gcc.11.2.0-cuda.11.7.1.openmpi.5.0.1/1cores/gcc.11.2.0-cuda.11.7.1.openmpi.5.0.1_1cores_replica3.out
