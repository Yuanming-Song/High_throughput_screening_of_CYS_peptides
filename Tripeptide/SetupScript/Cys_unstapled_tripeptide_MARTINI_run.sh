...
gmx grompp -p ${arg1}_${arg2}_${arg3}_CG.top -c equilibration.gro -f /dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/SetupScript/dynamic.mdp -o ${arg1}_${arg2}_${arg3}_CG_md.tpr -maxwarn 1 >gromppMD.log 2>&1
