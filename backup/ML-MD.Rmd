    ...
    print(
      ggplotly(
        ggplot(as.data.frame(gyrT[[seq]][[state]]))+
          ...
          labs(x="t (ns)",y="Principal Moments (Å^2)",title=paste(seq,stateformal))+
          plttheme+
          ylim(0,1)
      )
    )
...
save_plots <- 1
pltsavedir <- "/Users/song/Documents/Research/manuscript/APS2025/figures"
ml_pred_plot_script <- "~/Documents/Research/HPC/dfs2/mrsec/ML-MD-Peptide/DL_for_Peptide/ML_dEdge/analysis/plotting/plot_iteration1_results.R"
