...
for amino1 in "${amino_acids[@]}"; do
    ...
    for amino2 in "${amino_acids[@]}"; do
        for amino3 in "${amino_acids[@]}"; do
            ...
            sbatch --job-name="C_${amino1}_${amino2}_${amino3}" \
                ...
                --wrap="bash //dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/Tetrapeptide/MARTINI_Setup_script/Cys_stapled_tetrapeptide_MARTINI_run.sh C ${amino1} ${amino2} ${amino3}"
        done
    done
done
