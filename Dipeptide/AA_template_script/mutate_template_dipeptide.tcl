...
set template_dir /dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/Dipeptide/[lindex $argv 2]
...
segment A {
    pdb ${template_dir}/AA_dipeptide_dimer_template_A.pdb
...
coordpdb ${template_dir}/AA_dipeptide_dimer_template_A.pdb A
segment B {
    pdb ${template_dir}/AA_dipeptide_dimer_template_B.pdb
    mutate  1 $res1
    mutate  2 $res2
}
...
coordpdb ${template_dir}/AA_dipeptide_dimer_template_B.pdb B
...
writepdb ${mut_res1}_${mut_res2}.pdb
writepsf ${mut_res1}_${mut_res2}.psf
exit