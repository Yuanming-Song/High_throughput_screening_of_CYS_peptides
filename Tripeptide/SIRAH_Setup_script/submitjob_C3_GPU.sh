...
for amino1 in "${amino_acids1[@]}"; do
    ...
    for amino2 in "${amino_acids[@]}"; do
        ...
        new_job_id=$(
            sbatch --parsable \
                --job-name="${amino1}_${amino2}_C_dis" \
                ...
                --gres=gpu:${gpu_type} \
                --wrap="bash /dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/Tripeptide/SIRAH/Cys_stapled_tripeptide_SIRAH_run_GPU.sh ${amino1} ${amino2} C "
        )
