...
# Set paths
script="/dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/Edgelist/Rscript/Tetrapeptide/combine_edge_Tetrapeptide.R"
...
for pos in "${positions[@]}"; do
    for inpres_val in "${inpres[@]}"; do
        jobname="C${pos}_${inpres_val}_combine_edge"
...
# Export the dependency list to a file for potential downstream jobs
#echo "${dependency_list}" > "${log_dir}/combine_edge_job_ids.txt"

#echo "All jobs submitted. Job IDs saved to ${log_dir}/combine_edge_job_ids.txt" 
