...
/dfs9/tw/yuanmis1/vmd/bin/vmd -dispdev none -e /dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/dipeptide/SetupScript/mutate_template_mon_dipeptide.tcl -args ${arg1} ${arg2}  AA_template_dimer_C$IndexC > mutate_${arg1}_${arg2}.log 2>&1
...
python2.7 /dfs9/tw/yuanmis1/tools/martinize.py/martinize.py -f ${arg1}_${arg2}.pdb -o ${arg1}_${arg2}_CG.top -x ${arg1}_${arg2}_CG.pdb -ff martini21 -v -name ${arg1}_${arg2} -ss EEEEEE >${arg1}_${arg2}_CG_martinize.log 2>&1
...
# Modify setup script
gmx insert-molecules -box ${box_size_nm} ${box_size_nm} ${box_size_nm} -nmol 300 -ci ${arg1}_${arg2}_CG.pdb -radius 0.3 -o ${arg1}_${arg2}_CG_Lattice.gro >${arg1}_${arg2}_CG_multi_copy_setup.log 2>&1
...
if [ -f "solvate.log" ]; then
    ...
    sed -i "/${arg1}_${arg2}_A/s/1/300/" ${arg1}_${arg2}_CG.top
...
#sed -i 's/CL /CL- /g' ${arg1}_${arg2}_CG.top
...
gmx grompp -p ${arg1}_${arg2}_CG.top -c equilibration.gro -f /dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/dynamic.mdp -o ${arg1}_${arg2}_CG_md.tpr -maxwarn 1 >gromppMD.log 2>&1
echo "grompp MD production is done, check gromppMD.log file"
#generate psf file for easy viewing in VMD
/dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/getMARTINIpsf.sh -b ${arg1}_${arg2}_CG 
