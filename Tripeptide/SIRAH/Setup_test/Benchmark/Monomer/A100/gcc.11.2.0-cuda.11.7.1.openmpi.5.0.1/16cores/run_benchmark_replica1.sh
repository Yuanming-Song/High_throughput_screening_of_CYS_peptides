...
#SBATCH --time=0:30:00
#SBATCH --output=/dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/SIRAH/Setup_test/Benchmark/A100//gcc.11.2.0-cuda.11.7.1.openmpi.5.0.1/16cores/gcc.11.2.0-cuda.11.7.1.openmpi.5.0.1_16cores_replica1.out
