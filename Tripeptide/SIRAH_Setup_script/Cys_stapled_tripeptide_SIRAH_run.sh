...
echo -e "resname WT4\n" | gmx genion -s em1.tpr -o ${arg1}_${arg2}_${arg3}_CG_solvated_ions.gro -rmin 0.5 -p ${arg1}_${arg2}_${arg3}_SIRAH.top -nname ClW -pname NaW -neutral -np 0 > genion.log 2>&1
