...
core_counts=(8 16 24 32 40)

# Base directory for benchmarks
base_dir="/dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/SIRAH/Setup_test/Benchmark"
...
for version_key in "${!gmx_versions[@]}"; do
    ...
    for core_num in "${core_counts[@]}"; do
        ...
        for replica in {1..3}; do
            ...
            job_name="${version_key}_${core_num}nlist_replica${replica}"
...
cd $bench_dir
$gmx_cmd mdrun -s /dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/SIRAH/Setup_test/Benchmark/C_A_A_SIRAH_md.tpr -deffnm C_A_A_SIRAH_md_replica${replica}
EOL
