...
MartiniDir="/share/crsp/lab/dtobias/yuanmis1/mrsec/ML-MD-Peptide/Tripeptide_dis_C${IndexC}/${arg1}_${arg2}_${arg3}/"
#copy the pdb file from the martini folder
...
echo 1 | gmx pdb2gmx -f ${arg1}_${arg2}_${arg3}_CG.pdb -o ${arg1}_${arg2}_${arg3}_CG.gro -ff 'sirah' -p ${arg1}_${arg2}_${arg3}_SIRAH_single.top -merge all > ${arg1}_${arg2}_${arg3}_pdb2gmx.log 2>&1 
...
echo 1 | gmx pdb2gmx -f ${arg1}_${arg2}_${arg3}_CG_redo.pdb -o ${arg1}_${arg2}_${arg3}_CG_redo.gro -ff 'sirah' -p ${arg1}_${arg2}_${arg3}_SIRAH.top -merge all > ${arg1}_${arg2}_${arg3}_Lattice_pdb2gmx.log 2>&1 
...
#insert molecules
gmx insert-molecules -box ${inibox_size} ${inibox_size} ${inibox_size} -nmol ${ncopy} -ci ${arg1}_${arg2}_${arg3}_CG_redo.gro -radius ${radius} -o ${arg1}_${arg2}_${arg3}_CG_Lattice.gro -rot xyz > ${arg1}_${arg2}_${arg3}_CG_multi_copy_setup.log 2>&1
...
#/dfs9/tw/yuanmis1/vmd/bin/vmd -dispdev none H_C_E_CG_Lattice.gro -e /dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/SIRAH/rewrite_for_sirah.tcl  >  rewrite_for_sirah_${arg1}_${arg2}_${arg3}.log 2>&1
...
#solvate molecule
gmx solvate -cp ${arg1}_${arg2}_${arg3}_CG_Lattice.gro -cs ${SIRAHff}wt416.gro -o ${arg1}_${arg2}_${arg3}_CG_solvated.gro -box ${box_size_nm} ${box_size_nm} ${box_size_nm} -radius 0.3 -p ${arg1}_${arg2}_${arg3}_SIRAH.top > solvate.log 2>&1
...
echo "grompp minization of neutralized is done, check grompp_em1_CGPROT.log file"
#Run minimization
gmx mdrun -deffnm ${arg1}_${arg2}_${arg3}_SIRAH_em1 -v > em1_CGPROT.log 2>&1
echo "EM1 is done, check em1_CGPROT.log file"
...
gmx mdrun -deffnm ${arg1}_${arg2}_${arg3}_SIRAH_em2 >  EM2.log 2>&1
#Run equilibration
echo "Solvent equal is done, check em2_CGPROT.log file"
gmx grompp -f ${mdpdir}eq1_CGPROT.mdp -p ${arg1}_${arg2}_${arg3}_SIRAH.top -po eq1.mdp -n ${arg1}_${arg2}_${arg3}_CG_solvated2.ndx -c ${arg1}_${arg2}_${arg3}_SIRAH_em2.gro -r ${arg1}_${arg2}_${arg3}_SIRAH_em2.gro -o ${arg1}_${arg2}_${arg3}_SIRAH_eq1.tpr > grompp_eq1_CGPROT.log 2>&1
