...
for amino1 in "${amino_acids2[@]}"; do
    ...
    for amino2 in "${amino_acids[@]}"; do
        ...
        sbatch --job-name="C_${amino1}_${amino2}_mon" \
               ...
               --wrap="bash /dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/Cys_unstapled_tripeptide_MARTINI_run.sh C ${amino1} ${amino2} "
    done
done
