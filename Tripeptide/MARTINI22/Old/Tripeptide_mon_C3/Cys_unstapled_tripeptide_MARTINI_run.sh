...
/dfs9/tw/yuanmis1/vmd/bin/vmd -dispdev none -e /share/crsp/lab/dtobias/yuanmis1/mrsec/ML-MD-Peptide/Tripeptide_mon_C3/mutate_template_mon.tcl -args ${arg1} ${arg2} ${arg3} AA_template_dimer_C$IndexC > mutate_${arg1}_${arg2}_${arg3}.log 2>&1
