...
maindir="/share/crsp/lab//dtobias/yuanmis1/mrsec/ML-MD-Peptide/SIRAH/Tripeptide_mon_C${Cindex}_redo/" # Replace with your actual main directory path
#load file
...
for amino1 in "${amino_acids[@]}"; do
    ...
    for amino2 in "${amino_acids[@]}"; do
        ...
        for amino3 in "${amino_acids[@]}"; do
            ...
            echo 1 | gmx sasa -f "$xtc_file" -s "$gro_file" -o "$output_xvg" -dt $dt  >log/SASA_${amino1}_${amino2}_${amino3}_mon.log 2>&1
