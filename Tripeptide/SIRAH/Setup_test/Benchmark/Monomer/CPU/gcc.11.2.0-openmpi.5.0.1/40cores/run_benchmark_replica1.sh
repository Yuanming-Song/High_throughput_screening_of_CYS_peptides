#!/bin/bash
#SBATCH --job-name="gcc.11.2.0-openmpi.5.0.1_40cores_replica1"
...
#SBATCH --output=/dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/SIRAH/Setup_test/Benchmark/gcc.11.2.0-openmpi.5.0.1/40cores/gcc.11.2.0-openmpi.5.0.1_40cores_replica1.out
