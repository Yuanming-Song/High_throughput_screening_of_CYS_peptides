...
#SBATCH --time=0:10:00
#SBATCH --output=/dfs9/tw/yuanmis1/mrsec/ML-MD-Peptide/SIRAH/Setup_test/Benchmark/Dimer/A30//gcc.11.2.0-cuda.11.7.1.openmpi.5.0.1/8cores/gcc.11.2.0-cuda.11.7.1.openmpi.5.0.1_8cores_replica3.out
